...
<!-- attr: { id:'object-declaration', class:'', showInPresentation:true, hasScriptWrapper:true } -->
# <a id="object-declaration"></a>Declaring Objects
...
<!-- <img class="slide-image" showInPresentation="true" src="imgs/pic15.png" style="top:70%; left:75%; width:18.66%; z-index:-1" /> -->
...
<!-- <img class="slide-image" showInPresentation="true" src="imgs/pic17.png" style="top:50%; left:70%; width:25%; z-index:-1; border-radius: 15px" /> -->
...
<!-- <img class="slide-image" showInPresentation="true" src="imgs/pic22.png" style="top:55.54%; left:87.95%; width:17.41%; z-index:-1" /> -->
...
<!-- attr: { id:'constructors', class:'', showInPresentation:true, hasScriptWrapper:true } -->
...
<!-- section start -->
<!-- attr: { id:'enumerations', class:'slide-section', showInPresentation:true, hasScriptWrapper:true } -->
<!-- # <a id="enumerations"></a>Enumerations
...
<!-- <img class="slide-image" showInPresentation="true" src="imgs/pic41.png" style="top:29.97%; left:83.27%; width:21.16%; z-index:-1; border-radius: 15px" /> -->
...
<!-- <img class="slide-image" showInPresentation="true" src="imgs/pic00.png" style="top:60.37%; left:92.39%; width:13.45%; z-index:-1" /> -->
<!-- <img class="slide-image" showInPresentation="true" src="imgs/pic44.png" style="top:30.85%; left:68.14%; width:36.30%; z-index:-1" /> -->
<!-- <img class="slide-image" showInPresentation="true" src="imgs/pic45.png" style="top:46.32%; left:95.14%; width:10.85%; z-index:-1" /> -->
