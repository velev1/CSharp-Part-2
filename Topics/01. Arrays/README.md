...
### Table of Contents
- [Declaring and Creating Arrays](slides/README.md#/declaring-arrays)
- [Accessing Array Elements](slides/README.md#/accessing-arrays)
- [Console Input and Output of Arrays](slides/README.md#/in-out-arrays)
- [Iterating Over Arrays Using **for** and **foreach**](slides/README.md#/iterating-arrays)
- [Dynamic Arrays](slides/README.md#/dynamic-arrays)
  - [**List < T >**](slides/README.md#/lists)
- [Copying Arrays](slides/README.md#/copying-arrays)
